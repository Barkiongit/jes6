...
class App {
    ...
    registerHandlers() {
        this.formEl.onsubmit = event => this.addRepository(event); // registra quando algo é submitado
    }
    ...
    async addRepository(event) {
        event.preventDefault(); // previne o reload padrao da pagina no uso do form
